# <a href=https://tomilindmitry.github.io/neoflex/#/ style="color: white;">Neoflex</a>
...
1. **Модальное окно можно открыть по нажатию на изображение на карточке**.

2. **Модальное окно можно закрыть по нажатию на ESC,либо по области вне окна**

3. **По нажатию на Logo идет перенаправление на главную страницу (Как в футере так и в хедере)**
   
4. **При нажатии несколько раз на кнопку купить,количество предметов накапливается в корзине**
